<template>
  <div class="vl-parent">
    ...
    <div class="container">
      ...
      <PaginationComponent :pages="pagination" @emit-page="getProducts"></PaginationComponent>
    </div>
    <!-- Modal -->
    <ProductModal
      ref="productModal"
...
export default {
  ...
  methods: {
    ...
    updateProduct (item) {
      ...
      this.isLoading = true
      if (!this.isNew) {
        url = `${VITE_URL}/api/${VITE_PATH}/admin/product/${this.selectProduct.id}`
        httpMethod = 'put'
      }
    ...
    deleteProduct () {
      const url = `${VITE_URL}/api/${VITE_PATH}/admin/product/${this.selectProduct.id}`
      this.isLoading = true
